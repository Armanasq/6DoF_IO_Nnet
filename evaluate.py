...
def main():
    ...
    parser.add_argument('dataset', choices=['oxiod', 'euroc', 'broad'], help='Training dataset name (\'oxiod\' or \'euroc\')')
    ...
    for (cur_imu_data_filename, cur_gt_data_filename) in zip(imu_data_filenames, gt_data_filenames):
        if args.dataset == 'oxiod':
            ...
            gyro_data, acc_data, pos_data, ori_data = load_broad_dataset(cur_imu_data_filename, cur_gt_data_filename)
