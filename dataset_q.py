...
def load_dataset_quat(gyro_data, acc_data, pos_data, ori_data, window_size=200, stride=10):
    ...
    q = np.reshape(q, (len(q), q[0].shape[0]))

    return [x_gyro, x_acc], [q]
